    ...
    <section id="servicos" className="py-28" style={{ background: "var(--cream)" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 32 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-20">
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase mb-5" style={{ background: "rgba(196,98,45,0.10)", color: "#C4622D" }}>Nossos Serviços</span>
          <h2 className="mb-5" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 600, color: "#1C1917", lineHeight: 1.2 }}>
            Tudo que seu pet precisa<br />para uma viagem perfeita
          </h2>
          <p className="max-w-2xl mx-auto" style={{ color: "#78716C", fontSize: "1.0625rem", lineHeight: 1.7 }}>
            Cuidamos de cada detalhe para que a viagem internacional do seu pet seja segura, legal e tranquila. Do planejamento à chegada no destino.
          </p>
        </motion.div>
          ...
          {services.map((service, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mb-3" style={{ fontSize: "1.0625rem", fontWeight: 600, color: "#1C1917", lineHeight: 1.3 }}>{service.title}</h3>
